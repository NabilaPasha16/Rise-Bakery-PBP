          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                Text('Daftar Akun', style: GoogleFonts.poppins(fontSize: 22, fontWeight: FontWeight.bold, color: Colors.pink[400])),
                ...
                TextField(
                  ...
                  decoration: InputDecoration(
                    ...
                    labelText: 'Email',
                    labelStyle: GoogleFonts.poppins(fontSize: 14, color: Colors.pink[300]),
                ...
                SizedBox(
                  ...
                  child: ElevatedButton(
                    onPressed: _register,
                    style: ElevatedButton.styleFrom(backgroundColor: Colors.pink[300], padding: const EdgeInsets.symmetric(vertical: 14), shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(14))),
                    child: Text('Register', style: GoogleFonts.poppins(fontSize: 16, color: Colors.white, fontWeight: FontWeight.bold)),
                  ),
                ),
              ],
            ),
